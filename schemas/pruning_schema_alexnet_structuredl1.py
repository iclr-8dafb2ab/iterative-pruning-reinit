{
    ...
    ("classifier.1", "weight"): partial(prune.ln_structured, amount=0.2, axis=1, n=1),
    ("classifier.4", "weight"): partial(prune.ln_structured, amount=0.2, axis=1, n=1),
    ("classifier.6", "weight"): partial(prune.ln_structured, amount=0.2, axis=1, n=1),
}
