{
    ...
    ("classifier.0", "weight"): partial(prune.ln_structured, amount=0.2, n=1, axis=1),
    ("classifier.3", "weight"): partial(prune.ln_structured, amount=0.2, n=1, axis=1),
    ("classifier.6", "weight"): partial(prune.ln_structured, amount=0.2, n=1, axis=1),
}
